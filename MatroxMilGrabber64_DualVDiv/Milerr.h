...
#define M_ERR_13_SUBMSG_3        MIL_TEXT("Can not grab. Digitizer is already being used for a continuous grab")
...
#define M_ERR_51_SUBMSG_4        MIL_TEXT("The file format and image format is incompatible.")
...
#define M_ERR_75_SUBMSG_6        MIL_TEXT("Can not map buffers.")
...
#define M_ERR_76_SUBMSG_3        MIL_TEXT("Transfer can not be done asynchronously.")
...
#define M_ERR_78_SUBMSG_7        MIL_TEXT("The driver DLL has an invalid format and can not be loaded.")
...
#define M_ERR_102_SUBMSG_3       NO_SUBMSG
#define M_ERR_102_SUBMSG_4       NO_SUBMSG
#define M_ERR_102_SUBMSG_5       NO_SUBMSG
#define M_ERR_102_SUBMSG_6       NO_SUBMSG
#define M_ERR_102_SUBMSG_7       NO_SUBMSG
#define M_ERR_102_SUBMSG_8       NO_SUBMSG
...
#define M_ERR_103_SUBMSG_4       MIL_TEXT("Can not convert an internal data structure to 32 bits values.")
...
#define M_ERR_104_SUBMSG_4       NO_SUBMSG
#define M_ERR_104_SUBMSG_5       NO_SUBMSG
#define M_ERR_104_SUBMSG_6       NO_SUBMSG
#define M_ERR_104_SUBMSG_7       NO_SUBMSG
#define M_ERR_104_SUBMSG_8       NO_SUBMSG
...
#define M_ERR_106_SUBMSG_2       MIL_TEXT("This font doesn't support all character code, use another font.")
#define M_ERR_106_SUBMSG_3       MIL_TEXT("Your locale environment is not in UTF8.")
#define M_ERR_106_SUBMSG_4       MIL_TEXT("Maximum font cache reached.")
#define M_ERR_106_SUBMSG_5       NO_SUBMSG
#define M_ERR_106_SUBMSG_6       NO_SUBMSG
#define M_ERR_106_SUBMSG_7       NO_SUBMSG
#define M_ERR_106_SUBMSG_8       NO_SUBMSG
#define M_ERR_106_SUBMSG_9       NO_SUBMSG
...
#define M_ERR_109_SUBMSG_1       MIL_TEXT("Cannot draw a in world units in an uncalibrated image.")
...
#define M_ERR_110_SUBMSG_1       MIL_TEXT("Invalid inquire type for this graphic element.")
#define M_ERR_110_SUBMSG_2       MIL_TEXT("Invalid index.")
...
#define M_ERR_110_SUBMSG_8       NO_SUBMSG
#define M_ERR_110_SUBMSG_9       NO_SUBMSG
