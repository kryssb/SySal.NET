...
#if M_MIL_7_COMPATIBLE
   #error !!! Source code BackWard Compatibility to 7.0 is no longer supported. !!!
#endif

#ifdef M_MIL_75_COMPATIBLE
   #error !!! Source code BackWard Compatibility to 7.5 is no longer supported. !!!
#endif
...
#if BW_COMPATIBILITY==0x80
#define M_NO_CHECK                           MIL_MAKE_CONST(0x80000000L,0x0000000080000000)
#else
...
MFTYPE32 void MFTYPE    MedgeControlInt64  (MIL_ID       ContextOrResultId, 
                                            MIL_INT         ControlType, 
                                            MIL_INT64       ControlValue);
MFTYPE32 void MFTYPE    MedgeControlDouble (MIL_ID       ContextOrResultId, 
                                            MIL_INT         ControlType, 
                                            double       ControlValue);
#else
...
/* MedgeInquire()                                                          */
/***************************************************************************/
MFTYPE32 MIL_INT MFTYPE    MedgeInquire       (MIL_ID       ContextOrResultId, 
                                            MIL_INT         InquireType,
                                            void*        UserVarPtr);
...
MFTYPE32 void MFTYPE    MedgeGetNeighbors  (MIL_ID       ResultId,
                                            MIL_INT         SizeOfArray,
                                            const double*      SrcArrayXPtr,
                                            const double*      SrcArrayYPtr,
                                            const double*      SrcArrayAnglePtr,
                                            double*      DstArrayXPtr,
                                            double*      DstArrayYPtr,
                                            MIL_INT*        IndexPtr,
                                            MIL_INT*        LabelPtr,
...
MFTYPE32 void MFTYPE    MedgePut          (MIL_ID  ResultId,
                                           ...
                                           const double* ArrayXPtr,
                                           const double* ArrayYPtr,
                                           const double* ArrayAnglePtr,
                                           const double* ArrayMagnitudePtr,
                                           MIL_INT    ControlFlag);
...
/* MedgeSave() Unicode                                                     */
/***************************************************************************/
MFTYPE32 void MFTYPE    MedgeSaveW         (MIL_CONST_TEXT_PTR FileName,
...
/***************************************************************************/
MFTYPE32 MIL_ID  MFTYPE MedgeRestoreW      (MIL_CONST_TEXT_PTR FileName,
                                            MIL_ID       SystemId, 
                                            MIL_INT      ControlFlag,
                                            MIL_ID*      ContextIdPtr);
...
/* MedgeStream() Unicode                                                   */
/***************************************************************************/
MFTYPE32 void MFTYPE    MedgeStreamW      (MIL_TEXT_PTR MemPtrOrFileName, 
                                           MIL_ID       SystemId, 
                                           MIL_INT      Operation, 
                                           MIL_INT      StreamType,
                                           double       Version, 
...
/* MedgeSave() ASCII                                                       */
/***************************************************************************/
MFTYPE32 void MFTYPE    MedgeSaveA         (const char*     FileName,
                                            MIL_ID    ContextOrResultId,
                                            MIL_INT   ControlFlag);
...
/* MedgeRestore() ASCII                                                    */
/***************************************************************************/
MFTYPE32 MIL_ID  MFTYPE MedgeRestoreA      (const char*     FileName,
                                            MIL_ID    SystemId, 
                                            MIL_INT   ControlFlag,
                                            MIL_ID*   ContextIdPtr);
...
/* MedgeStream() ASCII                                                     */
/***************************************************************************/
MFTYPE32 void MFTYPE    MedgeStreamA      (char*      MemPtrOrFileName, 
                                           MIL_ID     SystemId, 
                                           MIL_INT    Operation, 
                                           MIL_INT    StreamType,
                                           double     Version, 
...
/* MedgeSave()                                                             */
/***************************************************************************/
MFTYPE32 void MFTYPE    MedgeSave          (MIL_CONST_TEXT_PTR FileName,
                                            MIL_ID       ContextOrResultId,
                                            MIL_INT      ControlFlag);
...
/* MedgeRestore()                                                          */
/***************************************************************************/
MFTYPE32 MIL_ID  MFTYPE MedgeRestore       (MIL_CONST_TEXT_PTR FileName,
                                            MIL_ID       SystemId, 
                                            MIL_INT      ControlFlag,
                                            MIL_ID*      ContextIdPtr);
...
inline MFTYPE32 void MFTYPE MedgeGetResultUnsafe  (MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, void           MPTYPE *FirstResultArrayPtr, void          MPTYPE *SecondResultArrayPtr);
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, int                    FirstResultArrayPtr, int                   SecondResultArrayPtr);
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_INT32      MPTYPE *FirstResultArrayPtr, MIL_INT32     MPTYPE *SecondResultArrayPtr);
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_INT64      MPTYPE *FirstResultArrayPtr, MIL_INT64     MPTYPE *SecondResultArrayPtr);
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_DOUBLE     MPTYPE *FirstResultArrayPtr, MIL_DOUBLE    MPTYPE *SecondResultArrayPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_UINT32     MPTYPE *FirstResultArrayPtr, MIL_UINT32    MPTYPE *SecondResultArrayPtr);
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_UINT64     MPTYPE *FirstResultArrayPtr, MIL_UINT64    MPTYPE *SecondResultArrayPtr);
#endif

// ----------------------------------------------------------
// MedgeInquire

inline MFTYPE32 MIL_INT MFTYPE MedgeInquireUnsafe  (MIL_ID ContextOrResultId, MIL_INT InquireType, void        MPTYPE *UserVarPtr);
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, int                 UserVarPtr);
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_INT32   MPTYPE *UserVarPtr);
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_INT64   MPTYPE *UserVarPtr);
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_DOUBLE  MPTYPE *UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_UINT32  MPTYPE *UserVarPtr);
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_UINT64  MPTYPE *UserVarPtr);
#endif
...
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, int FirstResultArrayPtr,int SecondResultArrayPtr)
   ...
   if (SecondResultArrayPtr || FirstResultArrayPtr)
      SafeTypeError(MT("MedgeGetResult"));

   MedgeGetResult(EdgeResultId, EdgeIndexOrLabelValue, ResultType, NULL, NULL);
   }

inline void MedgeGetResultSafeTypeExecute (MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, void          MPTYPE *FirstResultArrayPtr, void          MPTYPE *SecondResultArrayPtr, MIL_INT FirstGivenType, MIL_INT SecondGivenType)
   {
...
inline MFTYPE32 void MFTYPE MedgeGetResultUnsafe  (MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, void       MPTYPE *FirstResultArrayPtr, void       MPTYPE *SecondResultArrayPtr) {MedgeGetResult               (EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr);}
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_INT32  MPTYPE *FirstResultArrayPtr, MIL_INT32  MPTYPE *SecondResultArrayPtr) {MedgeGetResultSafeTypeExecute(EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr, M_TYPE_MIL_INT32, M_TYPE_MIL_INT32);}
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_INT64  MPTYPE *FirstResultArrayPtr, MIL_INT64  MPTYPE *SecondResultArrayPtr) {MedgeGetResultSafeTypeExecute(EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr, M_TYPE_MIL_INT64, M_TYPE_MIL_INT64);}
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_DOUBLE MPTYPE *FirstResultArrayPtr, MIL_DOUBLE MPTYPE *SecondResultArrayPtr) {MedgeGetResultSafeTypeExecute(EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr, M_TYPE_DOUBLE   , M_TYPE_DOUBLE   );}
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_UINT32  MPTYPE *FirstResultArrayPtr, MIL_UINT32 MPTYPE *SecondResultArrayPtr) {MedgeGetResultSafeTypeExecute(EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr, M_TYPE_MIL_INT32, M_TYPE_MIL_INT32);}
inline MFTYPE32 void MFTYPE MedgeGetResultSafeType(MIL_ID EdgeResultId, MIL_INT EdgeIndexOrLabelValue, MIL_INT ResultType, MIL_UINT64  MPTYPE *FirstResultArrayPtr, MIL_UINT64 MPTYPE *SecondResultArrayPtr) {MedgeGetResultSafeTypeExecute(EdgeResultId, EdgeIndexOrLabelValue, ResultType, FirstResultArrayPtr, SecondResultArrayPtr, M_TYPE_MIL_INT64, M_TYPE_MIL_INT64);}
#endif
...
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, int UserVarPtr)
   {
   if (UserVarPtr)
      SafeTypeError(MT("MedgeInquire"));

   return MedgeInquire(ContextOrResultId, InquireType, NULL);
   }

inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeTypeExecute (MIL_ID ContextOrResultId, MIL_INT InquireType, void MPTYPE *UserVarPtr, MIL_INT GivenType)
   {
...
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireUnsafe  (MIL_ID ContextOrResultId, MIL_INT InquireType, void       MPTYPE *UserVarPtr) {return MedgeInquire               (ContextOrResultId, InquireType, UserVarPtr                  );}
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_INT32  MPTYPE *UserVarPtr) {return MedgeInquireSafeTypeExecute(ContextOrResultId, InquireType, UserVarPtr, M_TYPE_MIL_INT32);}
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_INT64  MPTYPE *UserVarPtr) {return MedgeInquireSafeTypeExecute(ContextOrResultId, InquireType, UserVarPtr, M_TYPE_MIL_INT64);}
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_DOUBLE MPTYPE *UserVarPtr) {return MedgeInquireSafeTypeExecute(ContextOrResultId, InquireType, UserVarPtr, M_TYPE_DOUBLE   );}
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_UINT32 MPTYPE *UserVarPtr) {return MedgeInquireSafeTypeExecute(ContextOrResultId, InquireType, UserVarPtr, M_TYPE_MIL_INT32);}
inline MFTYPE32 MIL_INT MFTYPE MedgeInquireSafeType(MIL_ID ContextOrResultId, MIL_INT InquireType, MIL_UINT64 MPTYPE *UserVarPtr) {return MedgeInquireSafeTypeExecute(ContextOrResultId, InquireType, UserVarPtr, M_TYPE_MIL_INT64);}
#endif
