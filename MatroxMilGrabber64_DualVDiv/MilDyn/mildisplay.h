...
#define M_ALL_INIT_FLAGS                              0xF967D31FL
#define M_DOCUMENTED_INIT_FLAGS                       (M_WINDOWED|M_AUXILIARY|M_DUAL_SCREEN|M_VIDEO_ENCODER)
#define M_DISPLAY_LOCATION                            (M_LOCAL_DISPLAY|M_REMOTE_DISPLAY)

#if (BW_COMPATIBILITY == 0x80)
//TBR or at least set to M_INVALID.
...
#define M_REMOTE_DISPLAY_CONTROL                      0L
#define M_ORIGINAL_DISPLAY_CONTROL(X)                 X
#else
...
#define M_NUMBER                                      1009L
      ...
      #define M_FORMAT                                (1010L|M_CLIENT_ASCII_MODE)
   #else
...
#if (BW_COMPATIBILITY == 0x80)
   #define M_Q_FACTOR                                 33004L   // Already defined in mil.h
#else
...
#if (BW_COMPATIBILITY == 0x80)
   #define M_WINDOW_SNAP_X                               3075L + M_LOCAL_DISPLAY_CONTROL
   #define M_WINDOW_SNAP_Y                               3076L + M_LOCAL_DISPLAY_CONTROL
#endif
...
#define M_WINDOW_KEYBOARD_USE                         3155L + M_LOCAL_DISPLAY_CONTROL
#define M_KEYBOARD_USE                                M_WINDOW_KEYBOARD_USE
...
#define M_USE_USER_BUFFER_FOR_DDRAW_UNDERLAY          M_USE_USER_BUFFER_FOR_UNDERLAY
#define M_USE_DDRAW_UNDERLAY_IN_DUALHEAD              M_USE_UNDERLAY_IN_DUALHEAD
#define M_USE_LIVE_DDRAW_UNDERLAY                     M_USE_LIVE_UNDERLAY
...
#define M_SYS_DISPLAY_START                           4501L
   ...
   #define M_IS_IN_DISPLAY_SYS_RANGE(X)     (((X>=M_SYS_DISPLAY_START) && (X<=M_SYS_DISPLAY_END)) || ((X>=M_SYS_DISPLAY_RANGE2_START) && (X<=M_SYS_DISPLAY_RANGE2_END)) )
#endif //(BW_COMPATIBILITY != 0x80)
...
#if (BW_COMPATIBILITY == 0x80)
#define M_DISPLAY_OUTPUT_NUM                          M_NB_MATROX_DISPLAY_OUTPUT
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_SYSTEM_INDEX_OF_VGA                         M_SYS_DISPLAY_START+51L    //4552
#else
...
/*#else
#define M_APP_DISPLAY_START                           15300L
#endif //(BW_COMPATIBILITY == 0x80)*/
...
#define M_GENERATE_SPECIFICS_CAPS_FILE               (M_APP_HM_DISPLAY_START+46L)     // 346 // //obsolete
...
#define M_RESET_D3D9_DEVICE                           8502L
#define M_RELEASE_D3D9_DEVICE                         8503L
...
#if (BW_COMPATIBILITY == 0x80)
#define M_ZOOM_FACTOR_X                               (M_DISP_CONTROL_START+8L)    // 10008
#define M_ZOOM_FACTOR_Y                               (M_DISP_CONTROL_START+9L)    // 10009
#define M_PAN_OFFSET_X                                (M_DISP_CONTROL_START+10L)   // 10010
#define M_PAN_OFFSET_Y                                (M_DISP_CONTROL_START+11L)   // 10011
#endif //(BW_COMPATIBILITY == 0x80)
...
#define M_USE_YCRCB_RANGE                             (M_DISP_CONTROL_START+49L) + M_REMOTE_DISPLAY_CONTROL   // 10049
...
#define M_KEYBOARD_SHORTCUT                           (M_DISP_CONTROL_START+57L) + M_LOCAL_DISPLAY_CONTROL   // 10057
...
#if (BW_COMPATIBILITY == 0x80)
#define M_DISPLAY_SURFACE                             (M_DISP_CONTROL_START+101L)  // 10101
#define M_UNDERLAY_ID                                 (M_DISP_CONTROL_START+102L)  // 10102
#define M_USER_OVERLAY_ID                             (M_DISP_CONTROL_START+106L)  // 10106
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_COMPLEX_BUFFER                              (M_DISP_CONTROL_START+120L)  // 10120
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_WINDOW_ZOOM_FACTOR_X                        (M_DISP_CONTROL_START+127L) + M_LOCAL_DISPLAY_CONTROL  // 10127
#define M_WINDOW_ZOOM_FACTOR_Y                        (M_DISP_CONTROL_START+128L) + M_LOCAL_DISPLAY_CONTROL  // 10128
#define M_REAL_ZOOM_FACTOR_X                          (M_DISP_CONTROL_START+129L) + M_LOCAL_DISPLAY_CONTROL  // 10129
#define M_REAL_ZOOM_FACTOR_Y                          (M_DISP_CONTROL_START+130L) + M_LOCAL_DISPLAY_CONTROL  // 10130
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_BUFFER_TO_RECYCLE                           (M_DISP_CONTROL_START+136L)  // 10136
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#if (M_MIL_USE_UNICODE && !M_MIL_UNICODE_API && !M_COMPILING_MILDLL)
#define M_TITLE                                       ((M_DISP_CONTROL_START+142L)|M_CLIENT_ASCII_MODE)  // 75678
#else
#define M_TITLE                                       (M_DISP_CONTROL_START+142L) + M_LOCAL_DISPLAY_CONTROL  // 10142
#endif
#define M_TITLE_SIZE                                  (M_DISP_CONTROL_START+143L) + M_LOCAL_DISPLAY_CONTROL  // 10143
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_CHECK_POINT_STR                             (M_DISP_CONTROL_START+151L)  // 10151 // Move in MappInquire range: can be reuse
#define M_CHECK_POINT                                 (M_DISP_CONTROL_START+152L)  // 10152 // Move in MappInquire range: can be reuse
#endif //(BW_COMPATIBILITY == 0x80)
#define M_USE_ZOOM_HANDLE_BY_SCHEME                   (M_DISP_CONTROL_START+153L) + M_REMOTE_DISPLAY_CONTROL  // 10153
...
#if (BW_COMPATIBILITY == 0x80)
#define M_MEGA_BUFFER_CHILD                           (M_DISP_CONTROL_START+157L)  // 10157
#endif
...
#define M_MOVE_WINDOWS                                (M_DISP_CONTROL_START+174L) + M_LOCAL_DISPLAY_CONTROL  // 10174
...
//#if (BW_COMPATIBILITY != 0x80)
//#define M_WINDOW_MAXIMUM_ZOOM_FACTOR                  (M_DISP_CONTROL_START+183L)  // 10183
//#define M_WINDOW_MINIMUM_ZOOM_FACTOR                  (M_DISP_CONTROL_START+184L)  // 10184
//#endif //(BW_COMPATIBILITY != 0x80)
#define M_NUMBER_OF_BASIC_IMPLEMENTATIONS             (M_DISP_CONTROL_START+185L) + M_LOCAL_DISPLAY_CONTROL  // 10185
#if (BW_COMPATIBILITY == 0x80)
#define M_BASIC_DISPLAY_BUFFER                        (M_DISP_CONTROL_START+186L) + M_LOCAL_DISPLAY_CONTROL  // 10186
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_WINDOW_XDISPLAY                             (M_DISP_CONTROL_START+195L)  // 10195
#endif
...
#if (BW_COMPATIBILITY == 0x80)
#define M_USER_BUFFER_SHARED_WITH_SCHEME              (M_DISP_CONTROL_START+555L)  // 10555
#endif
...
#define M_WINDOW_LBUTTONDOWN        56L
#define M_WINDOW_RBUTTONDOWN        57L
#define M_WINDOW_LBUTTONUP          58L
#define M_WINDOW_RBUTTONUP          59L
#define M_WINDOW_PAINT_USER         60L
#define M_LOCAL_HOOK_RANGE5_END     M_WINDOW_PAINT_USER   /* End of fifth of local hooks */
...
#if OldDefinesSupport || (BW_COMPATIBILITY==0x80)
...
#define M_WINDOW_DEVICE_CONTEXT  3L
...
/************************************************************************/
/* Macros to have information about the scheme id                       */
/************************************************************************/
#define M_IS_DISPLAY_USING_UNDERLAY(DisplayID)        (MdispInquire(DisplayID, M_DISPLAY_SCHEME, M_NULL)&0x00000020)
#define M_IS_DISPLAY_USING_LIVE_UNDERLAY(DisplayID)   (MdispInquire(DisplayID, M_DISPLAY_SCHEME, M_NULL)&0x00800000)
#define M_IS_DISPLAY_USING_HOST_TRANSFER(DisplayID)   (MdispInquire(DisplayID, M_DISPLAY_SCHEME, M_NULL)&0x00000080)
