...
{
    /// <summary>
    /// Settings for full-speed acquisition.
    /// </summary>
    [Serializable]
    public class FullSpeedAcqSettings : SySal.Management.Configuration, ICloneable
    {
        /// <summary>
        ...
        /// <summary>
        /// Frames per second from the camera.
        /// </summary>
        public double FramesPerSecond = 200.0;
        /// <summary>
        /// Speed of Z axis during data-taking sweep.
        /// </summary>
        public double ZSweepSpeed { get { return Pitch * FramesPerSecond; } }
        /// <summary>
        /// Dead time in milliseconds of the motion controller before executing a move.
        /// </summary>
        public double MotionLatencyMS;
        /// <summary>
        /// Maximum number of views per strip.
        /// If a strip is expected to be longer, it is split into substrips.
        /// </summary>
        public uint MaxViewsPerStrip = 36;
        /// <summary>
        /// Number of minutes after which Z data in the focus map expire.        
        /// </summary>
        public uint ZDataExpirationMin = 120;

        public FullSpeedAcqSettings() : base("") { }

        public FullSpeedAcqSettings(string name) : base(name) { }

        internal static FullSpeedAcqSettings Default
        {
            get
            {
                FullSpeedAcqSettings c = SySal.Management.MachineSettings.GetSettings(typeof(FullSpeedAcqSettings)) as FullSpeedAcqSettings;
                if (c == null) c = new FullSpeedAcqSettings();
                return c;
            }
        }
        ...
        public const string FileExtension = "fullspeedacq.config";

        internal static System.Xml.Serialization.XmlSerializer s_XmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(FullSpeedAcqSettings));
    }
}
