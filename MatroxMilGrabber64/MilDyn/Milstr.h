...
inline MFTYPE32 MIL_INT MFTYPE MstrInquireExecute (MIL_ID ContextId, MIL_INT Index, MIL_INT InquireType, void       MPTYPE *ValuePtr, MIL_INT GivenType)
   ...
   MIL_INT RequiredType = (InquireType & (M_TYPE_MIL_INT32 | 
      ...
      M_TYPE_MIL_INT64 | 
#endif
      M_TYPE_DOUBLE |M_TYPE_CHAR | M_TYPE_SHORT | M_TYPE_MIL_ID | M_TYPE_FLOAT));
   if (RequiredType == 0)
...
inline void MstrGetResultExecute (MIL_ID ResultId, MIL_INT Index, MIL_INT ResultType, void       MPTYPE *ValuePtr, MIL_INT GivenType)
   ...
   MIL_INT RequiredType = (ResultType & (M_TYPE_MIL_INT32 | 
#if (BW_COMPATIBILITY != 0x80)
      M_TYPE_MIL_INT64 | 
#endif
      M_TYPE_DOUBLE |M_TYPE_CHAR | M_TYPE_SHORT | M_TYPE_FLOAT | M_TYPE_MIL_ID));
   if (RequiredType == 0)
