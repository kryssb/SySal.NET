...
#define M_MINIMUM_CONTRAST               600L      // Already defined in milstr.h
...
#define M_STRING_ARRAY            0x0000800EL
...
inline void McodeGetResultSafeTypeExecute (MIL_ID CodeId, MIL_INT ResultType, void       MPTYPE *ResultPtr, MIL_INT GivenType)
   ...
   MIL_INT RequiredType = (ResultType & (M_TYPE_CHAR | M_TYPE_SHORT | M_TYPE_MIL_INT32 | 
      ...
      M_TYPE_MIL_INT64 | 
#endif
      M_TYPE_FLOAT | M_TYPE_DOUBLE | M_TYPE_MIL_ID));
   if (RequiredType == 0)
...
inline MFTYPE32 MIL_INT MFTYPE McodeInquireSafeTypeExecute (MIL_ID CodeId, MIL_INT ParamToInquire, void       MPTYPE *ValuePtr, MIL_INT GivenType)
   {
   MIL_INT RequiredType = (ParamToInquire & (M_TYPE_MIL_INT32 | 
#if (BW_COMPATIBILITY != 0x80)
      M_TYPE_MIL_INT64 | 
#endif
