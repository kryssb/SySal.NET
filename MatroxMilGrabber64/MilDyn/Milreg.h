...
#define M_OWNER_SYSTEM                      1001L      /* already defined in mil.h */
#else
...
#if BW_COMPATIBILITY==0x80
#define M_MOSAIC_OFFSET_X                   0x80000006L /* should not be a valid dimension because can be ControlValue */
#define M_MOSAIC_OFFSET_Y                   0x80000007L /* should not be a valid dimension because can be ControlValue */
#else
...
#define M_TRANSLATION_ROTATION                           2L
#define M_TRANSLATION_ROTATION_SCALE                     3L
...
#if BW_COMPATIBILITY==0x80
#define M_CENTER_ELEMENT                        0x80000000L
#else
...
#if BW_COMPATIBILITY==0x80
#define M_REGISTRATION_GLOBAL                   0x08000000L
#else
...
#if BW_COMPATIBILITY==0x80
#define M_ALIGN_LEFT                            0x80000010L
#else
...
#if BW_COMPATIBILITY==0x80
#define M_ALIGN_TOP                             0x80000011L
#else
...
#if BW_COMPATIBILITY==0x80
#define M_REGISTRATION_GLOBAL                   0x08000000L
#define M_PREVIOUS                              0x80000003L
#define M_NEXT                                  0x80000004L
#else
#define M_REGISTRATION_GLOBAL                   0x02000000L
...
#if BW_COMPATIBILITY==0x80
#define M_MOSAIC_SIZE_X                         0x80000009L // also a ControlType
#define M_MOSAIC_SIZE_Y                         0x8000000AL // also a ControlType
#define M_MOSAIC_OFFSET_X                       0x80000006L // also a ControlType
#define M_MOSAIC_OFFSET_Y                       0x80000007L // also a ControlType
#else
...
#define M_ROLL                                          51L
#if BW_COMPATIBILITY==0x80
#define M_TRANSFORMATION_MATRIX_ID              0x00013000L // _ID should be far apart to avoid clash when adding for ex M_SIZE_X
#define M_REVERSE_TRANSFORMATION_MATRIX_ID      0x00014000L // _ID should be far apart to avoid clash when adding for ex M_SIZE_X
#else
...
inline void MregGetResultSafeTypeExecute (MIL_ID RegResultId, MIL_INT ResultIndex, MIL_INT ResultType, void MPTYPE *ResultPtr, MIL_INT GivenType)
   {
   MIL_INT RequiredType = (ResultType & (M_TYPE_CHAR | M_TYPE_SHORT | M_TYPE_MIL_INT32 | 
#if (BW_COMPATIBILITY != 0x80)
      M_TYPE_MIL_INT64 | 
#endif
